...
| Status Orange Graphic | `#c2410c` | `--color-status-orange-graphic` | Orange conforme WCAG 1.4.11 (5.2:1 sur blanc) pour les graphiques solides porteurs de sens (dots de statut, badges de grade) ; passe à `#fb923c` en thème sombre. Les tintes décoratives conservent Status Orange. |
...
:root {
  ...
  --color-status-orange-graphic: #c2410c;
