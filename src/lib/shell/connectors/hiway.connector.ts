...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpoZ2p0bGtmZXd1aWlvZnhmcnZoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA3NTQxMTYsImV4cCI6MjA2NjMzMDExNn0.yK8_ORWq4SYjQH11zvwA4g1MrIeagzErnWtoJWeukPI';
...
export class HiwayConnector extends BaseConnector {
	...
	private isConfigured(): boolean {
		return (
			!SUPABASE_URL.includes('<project-id>') &&
