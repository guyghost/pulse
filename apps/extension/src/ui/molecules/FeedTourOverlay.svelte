...
<div class="pointer-events-none fixed right-4 top-20 z-50 max-w-[min(20rem,calc(100vw-2rem))]">
  ...
  >
    ...
    <div class="mt-4 flex items-center justify-between gap-3">
      ...
      <button
        class="inline-flex items-center gap-2 rounded-lg border border-blueprint-blue/25 bg-blueprint-blue/88 px-4 py-2 text-xs font-semibold text-white transition-all duration-200 hover:brightness-105"
        onclick={onNext}
      >
